...
export class YoutubeAnalyticsController {
  ...
  public async sync(@Res() res: Response): Promise<Response> {
    const result = await this.commandBus.execute(
      new SyncYoutubeAnalyticsCommand(),
    );
  ...
  public async getVideoAnalytics(
    ...
    const result = await this.queryBus.execute(
      new GetYoutubeVideoAnalyticsQuery(id),
    );
    return res.status(HttpStatus.OK).json(result);
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'Trend analytics over a date range',
  })
  @ApiResponse({ status: 401, description: 'UNAUTHORIZED' })
  @ApiResponse({ status: 404, description: 'NOT_FOUND' })
  ...
  @ApiResponse({
    status: 200,
    description:
      'Top performing videos ordered by likes, views, watch time, publish date',
    type: YoutubeTopVideosModel,
  })
  @ApiResponse({ status: 401, description: 'UNAUTHORIZED' })
  public async getTopVideos(
    ...
    const result = await this.queryBus.execute(
      new GetYoutubeTopVideosQuery({ limit }),
    );
    return res.status(HttpStatus.OK).json(result);
  }
  ...
  @ApiResponse({
    status: 200,
    description:
      'Dashboard overview with current vs previous period comparison',
  })
  @ApiResponse({ status: 401, description: 'UNAUTHORIZED' })
  public async getOverview(
    ...
    const result = await this.queryBus.execute(
      new GetYoutubeOverviewQuery({ startDate, endDate }),
    );
    return res.status(HttpStatus.OK).json(result);
  }
  ...
  public async getDailyViews(
    ...
    const result = await this.queryBus.execute(
      new GetYoutubeDailyViewsQuery({ startDate, endDate }),
    );
    return res.status(HttpStatus.OK).json(result);
  }
  ...
  public async getWatchTime(
    ...
    const result = await this.queryBus.execute(
      new GetYoutubeWatchTimeQuery({ startDate, endDate }),
    );
    return res.status(HttpStatus.OK).json(result);
  }
  ...
  public async getSubscriberGrowth(
    ...
    const result = await this.queryBus.execute(
      new GetYoutubeSubscriberGrowthQuery({ startDate, endDate }),
    );
    return res.status(HttpStatus.OK).json(result);
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'Traffic sources from latest snapshot',
  })
  @ApiResponse({ status: 401, description: 'UNAUTHORIZED' })
  @ApiResponse({ status: 404, description: 'NOT_FOUND' })
  public async getTrafficSources(@Res() res: Response): Promise<Response> {
    const result = await this.queryBus.execute(
      new GetYoutubeTrafficSourcesQuery(),
    );
    return res.status(HttpStatus.OK).json(result);
  }
  ...
  @ApiResponse({
    status: 200,
    description: 'Audience demographics from latest snapshot',
  })
  @ApiResponse({ status: 401, description: 'UNAUTHORIZED' })
  @ApiResponse({ status: 404, description: 'NOT_FOUND' })
  ...
  @ApiResponse({
    status: 200,
    description: 'Geography breakdown from latest snapshot',
  })
  @ApiResponse({ status: 401, description: 'UNAUTHORIZED' })
  @ApiResponse({ status: 404, description: 'NOT_FOUND' })
  ...
  @ApiResponse({
    status: 200,
    description: 'Device breakdown from latest snapshot',
  })
  @ApiResponse({ status: 401, description: 'UNAUTHORIZED' })
  @ApiResponse({ status: 404, description: 'NOT_FOUND' })
  ...
  @ApiResponse({
    status: 200,
    description: 'Playback location breakdown from latest snapshot',
  })
  @ApiResponse({ status: 401, description: 'UNAUTHORIZED' })
  @ApiResponse({ status: 404, description: 'NOT_FOUND' })
  public async getPlaybackLocations(@Res() res: Response): Promise<Response> {
    const result = await this.queryBus.execute(
      new GetYoutubePlaybackLocationsQuery(),
    );
    return res.status(HttpStatus.OK).json(result);
  }
  ...
  public async getRevenue(
    ...
    const result = await this.queryBus.execute(
      new GetYoutubeRevenueQuery({ startDate, endDate }),
    );
    return res.status(HttpStatus.OK).json(result);
  }
}
