...
import { DeactivateUserRoleCommand, DeactivateUserRoleModel } from "./deactivate-user-role.handler";
...
export class DeactivateUserRoleController {
    ...
    public async Deactivate(
        ...
        await this.commandBus.execute(new DeactivateUserRoleCommand({ model: request }));
