...
import { CompleteOnboardingController } from './onboarding/complete/complete-onboarding.endpoint';

import { CompleteOnboardingCommandHandler } from './onboarding/complete/complete-onboarding.handler';
