...
import { OnboardingStep4Model, OnboardingStatusModel } from "../../../../domain/contracts/onboarding.model";
...
export class UpdateOnboardingStep4Controller {
  ...
  public async UpdateStep4(
    ...
    const result = await this.commandBus.execute(new OnboardingStep4Command({
      model: request
    }));
