...
export class OnboardingStep1CommandHandler implements ICommandHandler<OnboardingStep1Command, OnboardingStatusModel> {
  constructor(
    @Inject(_const.IUSER_REPOSITORY) private readonly userRepository: IUserRepository,
  ) { }

  public async execute(command: OnboardingStep1Command): Promise<OnboardingStatusModel> {
    ...
    if (user.onboardingStep === OnboardingStep.NotStarted || user.onboardingStep === null) {
