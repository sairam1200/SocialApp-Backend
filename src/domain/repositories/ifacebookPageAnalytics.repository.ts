...
export interface IFacebookPageAnalyticsRepository {
  createOrUpdateAsync(analytics: FacebookPageAnalytics): Promise<FacebookPageAnalytics>;
  ...
  getTrendsAsync(pageId: string, startDate: Date, endDate: Date): Promise<FacebookPageAnalytics[]>;
}
