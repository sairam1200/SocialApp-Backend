...
export interface IContentStreamRepository {
  ...
  deleteByPlatformAndExternalIdAsync(platform: string, externalId: string): Promise<void>;
  deleteByPlatformAndExternalIdsAsync(platform: string, externalIds: string[]): Promise<void>;
