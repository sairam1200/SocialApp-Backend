...
import { IContentStreamRepository, IUserContentRepository } from '../../../domain/repositories';

export const InjectContentStreamImportQueue = (): ParameterDecorator => InjectQueue(_const.BULL_QUEUES.CONTENT_STREAM_IMPORT);
