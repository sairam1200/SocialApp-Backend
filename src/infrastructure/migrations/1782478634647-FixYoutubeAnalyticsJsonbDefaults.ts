  ...
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "analytics"."youtubeChannelAnalytics" ALTER COLUMN "trafficSources" SET DEFAULT '{}'::jsonb`,
    );
    await queryRunner.query(
      `ALTER TABLE "analytics"."youtubeChannelAnalytics" ALTER COLUMN "geography" SET DEFAULT '{}'::jsonb`,
    );
    await queryRunner.query(
      `ALTER TABLE "analytics"."youtubeChannelAnalytics" ALTER COLUMN "devices" SET DEFAULT '{}'::jsonb`,
    );
    await queryRunner.query(
      `ALTER TABLE "analytics"."youtubeChannelAnalytics" ALTER COLUMN "playbackLocations" SET DEFAULT '{}'::jsonb`,
    );
  }
}
