...
export class PlaylistContentCreate1750887193061 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "playlistContent" ADD CONSTRAINT "FK_46c8f3bcf9fd39aa6d63fc6ee96" FOREIGN KEY ("playlistId") REFERENCES "playlists"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "playlistContent" ADD CONSTRAINT "FK_46650044a622fb1d42a6ba5be8f" FOREIGN KEY ("addedById") REFERENCES "playlistMembers"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "playlistContent" DROP CONSTRAINT "FK_46650044a622fb1d42a6ba5be8f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "playlistContent" DROP CONSTRAINT "FK_46c8f3bcf9fd39aa6d63fc6ee96"`,
    );
