export namespace Globals {
  ...
  export class ClaimTypes {
    ...
    public static readonly TwoFARequired =
      'http://gaddr.com/claims/2fa-required';
    public static readonly SecurityStamp =
      'http://gaddr.com/claims/security-stamp';
    public static readonly ConcurrencyStamp =
      'http://gaddr.com/claims/concurrency-stamp';
    ...
    public static readonly ProfileImage =
      'http://gaddr.com/claims/profile-picture';
